...
Let’s go ahead and press return.
...
>C:\test\output.txt to the end of the one-liner.
Now press return Now from the test folder, click on output.txt, we see that our application information is all there, could use some formatting, but that all looks good. Ok, thanks for watching and I’ll see you in the next lecture.