...
## Setup [02:51](https://threejs-journey.com/lessons/first-threejs-project#)[](https://threejs-journey.com/lessons/first-threejs-project#setup)

In the starter, all we have is the project how we left it in the previous lesson with the cube in the center of the view.

![](https://threejs-journey.com/assets/lessons/5/000.png)

## Move objects [07:12](https://threejs-journey.com/lessons/first-threejs-project#)[](https://threejs-journey.com/lessons/first-threejs-project#move-objects)
...
## Axes helper [20:09](https://threejs-journey.com/lessons/first-threejs-project#)[](https://threejs-journey.com/lessons/first-threejs-project#axes-helper)
...
/** * Axes Helper */ const axesHelper = new THREE.AxesHelper(2) scene.add(axesHelper)
...
## Scale objects [23:32](https://threejs-journey.com/lessons/first-threejs-project#)[](https://threejs-journey.com/lessons/first-threejs-project#scale-objects)
...
## Rotate objects [25:32](https://threejs-journey.com/lessons/first-threejs-project#)[](https://threejs-journey.com/lessons/first-threejs-project#rotate-objects)
...
#### Rotation[](https://threejs-journey.com/lessons/first-threejs-project#rotation)
...
#### Quaternion[](https://threejs-journey.com/lessons/first-threejs-project#quaternion)
...
#### Look at this![](https://threejs-journey.com/lessons/first-threejs-project#look-at-this)
...
## Combining transformations [38:59](https://threejs-journey.com/lessons/first-threejs-project#)[](https://threejs-journey.com/lessons/first-threejs-project#combining-transformations)
...
mesh.position.x = 0.7 mesh.position.y = - 0.6 mesh.position.z = 1 mesh.scale.x = 2 mesh.scale.y = 0.25 mesh.scale.z = 0.5 mesh.rotation.x = Math.PI * 0.25 mesh.rotation.y = Math.PI * 0.25

```

![](data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1792 1120'%3E%3C/svg%3E)

## Scene graph [39:41](https://threejs-journey.com/lessons/first-threejs-project#)[](https://threejs-journey.com/lessons/first-threejs-project#scene-graph)
...
/** * Objects */ const group = new THREE.Group() group.scale.y = 2 group.rotation.y = 0.2 scene.add(group) const cube1 = new THREE.Mesh( new THREE.BoxGeometry(1, 1, 1), new THREE.MeshBasicMaterial({ color: 0xff0000 }) ) cube1.position.x = - 1.5 group.add(cube1) const cube2 = new THREE.Mesh( new THREE.BoxGeometry(1, 1, 1), new THREE.MeshBasicMaterial({ color: 0xff0000 }) ) cube2.position.x = 0 group.add(cube2) const cube3 = new THREE.Mesh( new THREE.BoxGeometry(1, 1, 1), new THREE.MeshBasicMaterial({ color: 0xff0000 }) ) cube3.position.x = 1.5 group.add(cube3)
